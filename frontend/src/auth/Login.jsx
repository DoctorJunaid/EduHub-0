      ...
      <div className="lp-right">
        <div className="lp-right-inner">
          ...
          <div className="lp-panel-text">
            <a
              href={getLandingPageUrl()}
              className="lp-panel-brand-link"
              title="Visit EduHub Website"
            >
              <p className="lp-panel-brand">
                EduHub{" "}
                <ArrowUpRight
                  size={14}
                  style={{
            ...
            <p>
              EduHub is the centralized management platform for college and
              school administration. Access dashboards, academic data, and
              multi-school modules. Streamline your institution today.
            </p>
          ...
          <div className="lp-card">
            <div>
              ...
              <p>
                Access the easiest way to manage, collaborate, and excel in
                modern education.
              </p>
            </div>

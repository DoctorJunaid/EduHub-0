...
const Settings = () => {
  ...
  // Default values to structure the form
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        fetchSettings(); // Refresh to get updated inheritance
      }
    } catch (error) {
  ...
  return (
    <div className="settings-container p-8 max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Settings & Configuration</h1>
          <p className="text-gray-400">
            {isCampusManager ? "Manage your campus specific settings and overrides." : "Manage global default settings for your institute."}
          </p>
        </div>
        {isCampusManager && (
          <button
